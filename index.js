...
function filtrar_eventos(event) {
 ...
 crear_cartas(eventos, "nueva_carta");

// let primer_checkbox = document.getElementById("filtro1");
// // console.log(primer_checkbox[0]["checked"]);
// console.log(primer_checkbox["checked"]);
// // "category":"Food Fair",
// if (primer_checkbox["checked"]== true){
//        crear_cartas(eventos, "nueva_carta");
//     }
