...
let eventos_pasados = filtrar_eventosPasados(eventos);
...
function filtro_final(){
  let array_filtrado_porTexto = filtrar_porTexto(eventos_pasados, input.value);
  let array_filtrado_porCheckbox = filtrar_porCategoria(array_filtrado_porTexto);
  crear_cartas(array_filtrado_porCheckbox);
}

function filtrar_eventosPasados(eventos_array) {
...
//llamar funciones
crear_cartas(eventos_pasados);
crear_checkboxes(eventos_pasados);